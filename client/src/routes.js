...
const UsuariosAvanzado = React.lazy(() => import('./views/usuarios/UsuariosAvanzado'))
const Dashboard = React.lazy(() => import('./views/dashboard/Dashboard'))
const TicketsTable = React.lazy(() => import('./views/tickets/TicketsTable'))
const ReportePersonalizado = React.lazy(() => import('./views/reportes/ReportePersonalizado'))
