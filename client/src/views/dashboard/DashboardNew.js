...
const DashboardNew = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const response = await axios.get('http://localhost:3001/api/redmine/tickets?limit=2000')
      ...
      setError('Error al cargar los datos. Verifique la conexión con Redmine.')
    } finally {
      setLoading(false)
    }
  }
                    ...
                    <CCol lg={6} className="mb-4">
                      <CCard className="h-100 shadow-sm">
                        <CCardHeader className="bg-light border-0 d-flex justify-content-between align-items-center">
                          <div>
                            <h5 className="mb-0">🎯 Estados de Tickets</h5>
                            <small className="text-muted">Distribución actual</small>
                          </div>
                          <CBadge color="primary" pill>{kpiEstado.length} estados</CBadge>
                        </CCardHeader>
                        <CCardBody>
                    ...
                    <CCol lg={6} className="mb-4">
                      <CCard className="h-100 shadow-sm">
                        <CCardHeader className="bg-light border-0 d-flex justify-content-between align-items-center">
                          ...
                          <CBadge color="danger" pill>{statistics.ticketsCriticos} críticos</CBadge>
                        </CCardHeader>
                        <CCardBody>
                          <ResponsiveContainer width="100%" height={300}>
                            <BarChart data={kpiPrioridad} layout="horizontal">
                              <CartesianGrid strokeDasharray="3 3" />
                              <XAxis type="number" />
                              <YAxis dataKey="prioridad" type="category" width={80} />
                              <Tooltip />
                    ...
                    <CCol>
                      <CCard className="shadow-sm">
                        <CCardHeader className="bg-light border-0">
                          <h5 className="mb-0">📈 Tendencia - Últimos 7 días</h5>
                ...
                <CTabPane visible={activeTab === 'trends'}>
                  <CRow className="mb-4">
                    <CCol>
                      <CCard className="shadow-sm">
                        <CCardHeader className="bg-light border-0">
                          <h5 className="mb-0">📊 Tendencia - Últimos 30 días</h5>
                  ...
                  <CRow className="mb-4">
                    <CCol>
                      <CCard className="shadow-sm">
                        <CCardHeader className="bg-light border-0">
                          <h5 className="mb-0">📅 Evolución Mensual</h5>
                  ...
                  <CRow>
                    <CCol>
                      <CCard className="shadow-sm">
                        <CCardHeader className="bg-light border-0">
                          <h5 className="mb-0">⏰ Distribución de Tiempo de Resolución</h5>
                ...
                <CTabPane visible={activeTab === 'performance'}>
                  <CRow className="mb-4">
                    <CCol>
                      <CCard className="shadow-sm">
                        <CCardHeader className="bg-light border-0">
                          <h5 className="mb-0">🎯 Eficiencia de Técnicos</h5>
                  ...
                  <CRow>
                    <CCol lg={6}>
                      <CCard className="shadow-sm">
                        <CCardHeader className="bg-light border-0">
                          <h5 className="mb-0">👥 Carga de Trabajo por Técnico</h5>
                          <small className="text-muted">Distribución actual</small>
                        </CCardHeader>
                        <CCardBody>
                          <ResponsiveContainer width="100%" height={350}>
                    ...
                    <CCol lg={6}>
                      <CCard className="shadow-sm">
                        <CCardHeader className="bg-light border-0">
                          <h5 className="mb-0">📊 Tickets Críticos por Técnico</h5>
                ...
                <CTabPane visible={activeTab === 'analysis'}>
                  <CRow className="mb-4">
                    <CCol>
                      <CCard className="shadow-sm">
                        <CCardHeader className="bg-light border-0">
                          <h5 className="mb-0">🏢 Análisis por Oficina</h5>
                  ...
                  <CRow className="mb-4">
                    <CCol lg={6}>
                      <CCard className="shadow-sm">
                        <CCardHeader className="bg-light border-0">
                          <h5 className="mb-0">🔍 Análisis de Correlación</h5>
